...
use Roots\Acorn\Assets\AssetDirective;
...
return [
    ...
    */
    ...
    'paths' => [
        plugin('directory') . '/resources/views',
    ],
    ...
    */
    ...
    'namespaces' => [
         ...
         */
    // 'Roots\Plugin\Share\Admin' => WP_PLUGIN_DIR . '/roots-share-button/resources/views/admin/',
    ],
    ...
    */
    ...
    'composers' => [
        // Clover\Composers\AdminNotice::class,
    ],
